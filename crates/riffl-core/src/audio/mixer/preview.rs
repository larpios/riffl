...
impl super::Mixer {
    ...
    pub fn set_tpl(&mut self, tpl: u32) {
        ...
        // Recompute frames_per_row so timing-dependent effects (vibrato, tremolo,
        // note delay, arpeggio) stay correct after a speed change (Fxx).
        self.effect_processor.update_tempo(self.bpm);
    }
