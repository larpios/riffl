fn main() {
    ...
    println!("Tracker Core native rate for C-4: {} * {} = {}", 8363.0, ratio, 8363.0 * ratio);
    ...
    println!("Tracker Core C-5 play ratio: {}", target_freq_wrong / base_freq);
    ...
    println!("Tracker Core PT C-2 play ratio: {}", target_freq_pt / base_freq_pt);
}
