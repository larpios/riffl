...
pub fn render_pattern_list(
    ...
    for (idx, pattern) in song.patterns.iter().enumerate() {
        ...
        let description = if is_current { "Currently editing" } else { "" };
...
mod tests {
    ...
    fn test_render_pattern_list_no_panic_with_patterns() {
        ...
        song.add_pattern(tracker_core::pattern::Pattern::new(32, 4));
        song.add_pattern(tracker_core::pattern::Pattern::new(16, 8));
        let theme = Theme::default();
