...
*** Prerequisites
- *Rust:* Install via [[https://rustup.rs/][rustup.rs]]
- *Audio Libraries:*
...
- Check [[ACCEPTANCE_TEST.md]] for details.

** 🤝 Contributing

See [[AGENTS.md]] for development guidelines and our issue tracking protocol using ~bd`.
